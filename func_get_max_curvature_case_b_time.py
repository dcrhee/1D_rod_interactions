...
from func_get_curvature_case1 import func_get_all_curvatures_b_case1
from func_get_curvature_case2 import func_get_all_curvatures_b_case2
from func_get_curvature_case3 import func_get_all_curvatures_b_case3
from func_get_curvature_case4 import func_get_all_curvatures_b_case4
from func_get_curvature_case0 import func_get_all_curvatures_b_case0
from func_get_all_maxes import func_get_all_maxes

def get_max_curvature_case_b_time(y, t, gamma):          
                ...
                for indx in range(len(t)):
                    ...
                    Lb = 1/gamma # length of rod b
    
                    xb_24_0 = P - Lb # left hand point of rod B in cases 2 and 4
                    xb_13_0 = x1 # left hand point of rod B in cases 1 and 3
    
                    xb_24 = np.linspace(xb_24_0, xb_24_0+Lb, 1000)
                    xb_13 = np.linspace(xb_13_0, xb_13_0+Lb, 1000)
                    
                    
                    if case_num == 0:
                        # get h and theta (check this one)
                        y2_deriv, y2_deriv_p_V, y2_deriv_p_Om = func_get_all_curvatures_b_case0(xb_13, h, theta, V, Omega, hinc)
                        max_deriv, xmax, max_pV, max_pOmega = func_get_all_maxes(xb_13, y2_deriv, y2_deriv_p_V, y2_deriv_p_Om)
                    elif case_num == 1:
                        h = z_as - theta*(1/2 - x1)
                        y2_deriv, y2_deriv_p_V, y2_deriv_p_Om = func_get_all_curvatures_b_case1(xb_13, V, Omega, h, theta) # x-axis of B, V, Omega, h
                        max_deriv, xmax, max_pV, max_pOmega = func_get_all_maxes(xb_13, y2_deriv, y2_deriv_p_V, y2_deriv_p_Om)
                    elif case_num == 2:
                        y2_deriv, y2_deriv_p_V, y2_deriv_p_Om = func_get_all_curvatures_b_case2(xb_24, V, Omega, h, theta) # x-axis of B, V, Omega, h
                        max_deriv, xmax, max_pV, max_pOmega = func_get_all_maxes(xb_24, y2_deriv, y2_deriv_p_V, y2_deriv_p_Om)
                    elif case_num == 3:
                       y2_deriv, y2_deriv_p_V, y2_deriv_p_Om = func_get_all_curvatures_b_case3(xb_13, V, Omega, h, theta) # x-axis of B, V, Omega, h
                       max_deriv, xmax, max_pV, max_pOmega = func_get_all_maxes(xb_13, y2_deriv, y2_deriv_p_V, y2_deriv_p_Om)
                    else:
                        h = z_as - theta*(P-1/2)
                        y2_deriv, y2_deriv_p_V, y2_deriv_p_Om = func_get_all_curvatures_b_case4(xb_24, V, Omega, h, theta) # x-axis of B, V, Omega, h
                        max_deriv, xmax, max_pV, max_pOmega = func_get_all_maxes(xb_24, y2_deriv, y2_deriv_p_V, y2_deriv_p_Om)
